                          ...
                          <div class="w-full flex-col justify-center items-start gap-8 flex">
                              <div class="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                                  ...
                                  <p class="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">
                                      Welcome to [Your Shop Name] — your one-stop shop for all electrical needs. We offer a wide range of quality products like wires, switches, lights, fans, and more from trusted brands like Legrand, Hi-Fi, Norwood, RR-cables,finolex Pipes  and Wires.
